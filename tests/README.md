...
- `MD_URL` — the same, for `graph.js`, `find.js`, `nav.js`, `wbrename.js`, `wbtodo.js`, `importance.js`, `idea.js` and `paste.js`, which drive
...
`recipes.js`, `mealplan.js`, `targets.js`, `graph.js`, `find.js`, `nav.js`, `wbrename.js`, `wbsaveall.js`, `wbtodo.js`, `importance.js`, `idea.js`, `paste.js`, `calendar.js`, `drive.js` and `voice.js` are the scripts that do **not** use
